...
async function main() {
    const levelRanges = [
        { level: client_1.Level.BEGINNER, minScore: 0, maxScore: 20 },
        { level: client_1.Level.ELEMENTARY, minScore: 21, maxScore: 40 },
        { level: client_1.Level.INTERMEDIATE, minScore: 41, maxScore: 60 },
        { level: client_1.Level.UPPER_INTERMEDIATE, minScore: 61, maxScore: 80 },
        { level: client_1.Level.ADVANCED, minScore: 81, maxScore: 100 },
    ];
    ...
    const sentenceData = [
        ...
        {
            level: client_1.Level.ELEMENTARY,
            sentences: [
                {
                    ...
                    explanation: '현재완료 진행형으로, 과거부터 지금까지 계속 진행 중인 일을 표현합니다.',
                },
                {
        ...
        {
            level: client_1.Level.INTERMEDIATE,
            sentences: [
                {
        ...
        {
            level: client_1.Level.UPPER_INTERMEDIATE,
            sentences: [
                {
